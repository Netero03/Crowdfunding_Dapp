...
const DisplayCampaignsforUsers = ({ title, isLoading, campaigns }) => {
  const navigate = useNavigate();

  const handleNavigate = (campaign) => {
    navigate(`/campaign-details-users/${campaign.title}`, { state: campaign })
  }
...
export default DisplayCampaignsforUsers